      ...
      <div className='flex flex-col items-center py-10 w-[304px]'>
        ...
        <span className='text-lx mt-2'>Agradecemos o feedback</span>
          <button
            ...
            className="py-2 px-6 mt-6 bg-[#00856F] rounded-md border-transparent text-sm leading-6 hover:bg-zinc-700  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500 transition-colors disabled:opacity-50 disabled:hover:bg-brand-500"
          >
            Quero enviar outro
          </button>
      </div>
